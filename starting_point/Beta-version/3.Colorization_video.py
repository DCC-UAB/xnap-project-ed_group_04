...
plt.grid(True)
plt.tight_layout()
plt.savefig('starting_point/Beta-version/result-curves-gif/curva_training_gif_paisatge.png')
plt.close()
...
plt.grid(True)
plt.tight_layout()
plt.savefig('starting_point/Beta-version/result-curves-gif/curva_validation_gif_paisatge.png')
plt.close()
